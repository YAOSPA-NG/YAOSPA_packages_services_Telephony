 ...
 * Copyright (C) 2016 Yank555.lu's Android Open Source Project
 *
...
package com.android.phone.settings.preferences;
...
public class CustomSeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String PHONE_NS = "http://schemas.android.com/apk/res/com.android.phone";
    ...
    public CustomSeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        mMax = attrs.getAttributeIntValue(PHONE_NS, "maximum", 100);
        mMin = attrs.getAttributeIntValue(PHONE_NS, "minimum", 0);
        mDefaultValue = attrs.getAttributeIntValue(ANDROIDNS, "defaultValue", -1);
        mUnits = getAttributeStringValue(attrs, PHONE_NS, "units", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(PHONE_NS, "interval");
            if (newInterval != null)
        ...
        setLayoutResource(R.layout.custom_seek_bar_preference);
    }
